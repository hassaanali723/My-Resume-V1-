...
class Visual_Portfolio_Custom_Post_Type {
    ...
    public function add_custom_post_type() {
        ...
        register_post_type(
            ...
            array(
                'labels'          => array(
                    'name'               => _x( 'Saved', 'Post Type General Name', 'visual-portfolio' ),
                    'singular_name'      => _x( 'Saved Layout', 'Post Type Singular Name', 'visual-portfolio' ),
                    'menu_name'          => __( 'Visual Portfolio', 'visual-portfolio' ),
                    'parent_item_colon'  => __( 'Parent Portfolio Item', 'visual-portfolio' ),
                    'all_items'          => __( 'Saved', 'visual-portfolio' ),
    ...
    public function add_role_caps() {
        ...
        if ( get_option( 'visual_portfolio_updated_caps' ) === '2.0.0' ) {
            return;
        }
        ...
        update_option( 'visual_portfolio_updated_caps', '2.0.0' );
    }
