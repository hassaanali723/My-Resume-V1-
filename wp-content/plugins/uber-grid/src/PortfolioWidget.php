...
class PortfolioWidget extends WP_Widget
{
    public function __construct() {
        parent::__construct(
            '\PfhubPortfolio\PortfolioWidget',
            'PortfolioHub Portfolio',
            array( 'description' => __( 'PortfolioHub Portfolio', 'pfhub_portfolio_portfolio' ), )
        );
    }
    ...
    public function widget( $args, $instance ) {
        if ( isset( $instance['grid_id'] ) ) {
            ...
            echo do_shortcode( "[pfhub_portfolio_portfolio id={$grid_id}]" );
    ...
    public function form( $instance ) {
        ...
        <label
            for="<?php echo $this->get_field_id( 'grid_id' ); ?>"><?php _e( 'Select portfolio:', 'pfhub_portfolio_portfolio' ); ?></label>
