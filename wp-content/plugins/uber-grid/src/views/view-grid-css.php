...
<style>
    ...
    .pfhub-portfolio-panel_<?php echo $portfolioID; ?> .description-block_<?php echo $portfolioID; ?>, .portelement_<?php echo $portfolioID; ?> div.right-block .description-block_<?php echo $portfolioID; ?> * {
        position:relative;
        clear:both;
    }

    .pfhub-portfolio-panel_<?php echo $portfolioID; ?> .description-block_<?php echo $portfolioID; ?> p,.pfhub-portfolio-panel_<?php echo $portfolioID; ?> .description-block_<?php echo $portfolioID; ?> * {
        text-align:justify;
        /*font-weight:normal;*/
    ...
    .pfhub-portfolio-panel_<?php echo $portfolioID; ?> .description-block_<?php echo $portfolioID; ?> {
        font-family: 'Open Sans', sans-serif;
    }

    .pfhub-portfolio-panel_<?php echo $portfolioID; ?> .description-block_<?php echo $portfolioID; ?> h1,
    .pfhub-portfolio-panel_<?php echo $portfolioID; ?> .description-block_<?php echo $portfolioID; ?> h2,
    .pfhub-portfolio-panel_<?php echo $portfolioID; ?> .description-block_<?php echo $portfolioID; ?> h3,
    .pfhub-portfolio-panel_<?php echo $portfolioID; ?> .description-block_<?php echo $portfolioID; ?> h4,
    .pfhub-portfolio-panel_<?php echo $portfolioID; ?> .description-block_<?php echo $portfolioID; ?> h5,
    .pfhub-portfolio-panel_<?php echo $portfolioID; ?> .description-block_<?php echo $portfolioID; ?> h6,
    .pfhub-portfolio-panel_<?php echo $portfolioID; ?> .description-block_<?php echo $portfolioID; ?> p,
    .pfhub-portfolio-panel_<?php echo $portfolioID; ?> .description-block_<?php echo $portfolioID; ?> strong,
    .pfhub-portfolio-panel_<?php echo $portfolioID; ?> .description-block_<?php echo $portfolioID; ?> span {
        padding:2px !important;
        margin: 0 !important;
    }

    .pfhub-portfolio-panel_<?php echo $portfolioID; ?> .description-block_<?php echo $portfolioID; ?> ul,
    .pfhub-portfolio-panel_<?php echo $portfolioID; ?> .description-block_<?php echo $portfolioID; ?> li {
        padding:2px 0 2px 5px;
        margin: 0 0 0 8px;
    }


    .pfhub-portfolio-panel_<?php echo $portfolioID; ?> .thumbs-list_<?php echo $portfolioID; ?> {
        position:relative;
        clear:both;
        list-style:none;
        display:table;
    ...
    .pfhub-portfolio-panel_<?php echo $portfolioID; ?> .thumbs-list_<?php echo $portfolioID; ?> li {
        display:inline-block;
        margin: 0 3px 0 2px;
    }

    .pfhub-portfolio-panel_<?php echo $portfolioID; ?> .thumbs-list_<?php echo $portfolioID; ?> li a {
        display:block;
    ...
    .pfhub-portfolio-panel_<?php echo $portfolioID; ?> .thumbs-list_<?php echo $portfolioID; ?> li a:hover {
        opacity:1;
    }

    .pfhub-portfolio-panel_<?php echo $portfolioID; ?> img {
        margin: 0 !important;
        padding: 0 !important;
        display:table-cell;
    ...
    .pfhub-portfolio-panel_<?php echo $portfolioID; ?> > div {
        position:relative;
        clear:both;
        padding-top:10px;
        margin-bottom:10px;
    ...
    .pfhub-portfolio-panel_<?php echo $portfolioID; ?> .button-block {
        padding-top:10px;
        margin-bottom:10px;
        font-family: 'Open Sans', sans-serif;
    }

    .pfhub-portfolio-panel_<?php echo $portfolioID; ?> .button-block a, .pfhub-portfolio-panel_<?php echo $portfolioID; ?> .button-block a:link, .pfhub-portfolio-panel_<?php echo $portfolioID; ?> .button-block a:visited {
        padding:6px 12px;
    ...
    .pfhub-portfolio-panel_<?php echo $portfolioID; ?> .button-block a:hover, .pfhub-portfolio-panel_<?php echo $portfolioID; ?> .button-block a:focus, .pfhub-portfolio-panel_<?php echo $portfolioID; ?> .button-block a:active {
    ...
    #pfhub_portfolio_portfolio_content_<?php echo $portfolioID; ?> #pfhub_portfolio_portfolio_filters_<?php echo $portfolioID; ?>  ul li a:focus,
    #pfhub_portfolio_portfolio_content_<?php echo $portfolioID; ?> #pfhub_portfolio_portfolio_filters_<?php echo $portfolioID; ?>  ul li a:active {
    ...
    @media screen and (max-width: 480px) {
        #pfhub_portfolio_portfolio_container_<?php echo $portfolioID; ?>{
            width:100%;
        }
        #pfhub_portfolio_portfolio_content_<?php echo $portfolioID; ?> #pfhub_portfolio_portfolio_options_<?php echo $portfolioID; ?> {
            float: left;
