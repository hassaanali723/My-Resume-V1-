...
?>
<section id="pfhub_portfolio_portfolio_content_<?php echo esc_attr($portfolioID); ?>" style="clear: both" class="portfolio-gallery-content <?php if ( $portfolioShowSorting == 'on' ) {
    echo 'sortingActive ';
}
if ( $portfolioShowFiltering == 'on' ) {
    ...
    <div id="pfhub_portfolio_portfolio_options_and_filters_<?php echo esc_attr($portfolioID); ?>">
        <?php } ?>
        <?php if ( $portfolioShowSorting == "on" ) { ?>
            <div id="pfhub_portfolio_portfolio_options_<?php echo esc_attr($portfolioID); ?>"
        ...
        <?php }
        if ( $portfolioShowFiltering == "on" ) { ?>
            <div id="pfhub_portfolio_portfolio_filters_<?php echo esc_attr($portfolioID); ?>"
...
<?php } ?>
    <div id="pfhub_portfolio_portfolio_container_<?php echo esc_attr($portfolioID); ?>"
         data-show-loading="<?php echo esc_attr($portfolioShowLoading); ?>"
         data-show-center="<?php echo esc_attr($portfolioposition); ?>"
         class="pfhub_portfolio_portfolio_container super-list variable-sizes clearfix view-<?php echo esc_attr($view_slug);?>" <?php if ( $pfhub_portfolio_get_options["pfhub_portfolio_view0_sorting_float"] == "top" && $pfhub_portfolio_get_options["pfhub_portfolio_view0_filtering_float"] == "top" ) {
        ...
        foreach ( $images as $key => $row ) {
            ...
            <div
                ...
                <div class="default-block_<?php echo esc_attr($portfolioID); ?> <?php echo esc_attr($lighboxable); ?>" style="<?php if( $row->name == '' && count($imgurl) < 3 && $imgurl[1] =='' && $row->description == '' && $link == '') echo "height:".$pfhub_portfolio_get_options['pfhub_portfolio_view0_block_height']."px !important;";?>">
                    <div class="image-block image-block_<?php echo esc_attr($portfolioID); ?>  add-H-relative">
                        ...
                        if ( $row->image_url != ';' ) {
                            switch ( \PfhubPortfolio\Helpers\GridHelper::getVideoType( $imgurl[0] ) ) {
                                ...
                                case 'youtube':
                                    ...
                                    <a href="https://www.youtube.com/embed/<?php echo esc_attr($videourl[0]); ?>"
                                       ...
                                       class="pfhub_portfolio_portfolio_item pyoutube portfolio-group<?php if ( $lighboxable == "lighboxable" ) {
                                ...
                                case 'vimeo':
                                    ...
                                    <a href="http://player.vimeo.com/video/<?php echo esc_attr($videourl[0]); ?>"
                                       data-description=" <?php echo esc_attr( $row->description ); ?>"
                                       class="pfhub_portfolio_portfolio_item pvimeo portfolio-group<?php if ( $lighboxable == "lighboxable" ) {
                                           echo esc_attr($group_key);
                                       } ?> " title="<?php echo esc_attr( $row->name ); ?>" data-groupID="<?php echo esc_attr($group_key);?>">
                                        <img alt="<?php echo esc_attr( $row->name ); ?>"
                            ...
                            <img alt="<?php echo esc_attr( $row->name ); ?>"
                                 id="pfhub-cl-img<?php echo esc_attr($key); ?>" src="images/noimage.jpg"/>
                            <?php
                        } ?>
                    </div>
                ...
                <div class="pfhub-portfolio-panel pfhub-portfolio-panel_<?php echo esc_attr($portfolioID); ?>" id="panel<?php echo esc_attr($key); ?>">
                    <?php
                    $imgurl = explode( ";", $row->image_url );
                                    ...
                                    <li>
                                        ...
                                        switch ( \PfhubPortfolio\Helpers\GridHelper::getVideoType( $img ) ) {
                                            ...
                                            case 'youtube':
                                                ...
                                                <a href="https://www.youtube.com/embed/<?php echo esc_attr($videourl[0]); ?>"
                                                   data-description=" <?php echo esc_attr( $row->description ); ?>"
                                                   class="pfhub_portfolio_portfolio_item pyoutube portfolio-group<?php echo esc_attr($group_key); ?> "
                                            ...
                                            case 'vimeo':
                                                ...
                                                $hash = unserialize( wp_remote_fopen( "https://vimeo.com/api/v2/video/" . $videourl[0] . ".php" ) );
                                                $imgsrc = $hash[0]['thumbnail_large']; ?>
                                                <a class="pfhub_portfolio_portfolio_item pvimeo portfolio-group<?php echo esc_attr($group_key); ?> "
                                                   data-description=" <?php echo esc_attr( $row->description ); ?>"
