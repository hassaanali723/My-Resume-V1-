...
global $wpdb;
$portfolio_wp_nonce = wp_create_nonce( 'pfhub_portfolio_portfolio_nonce' );
$id                 = intval( $_GET['id'] );
?>
...
<div class="wrap" id="pfhub_portfolio_admin_wrap">
    ...
    $form_action = wp_nonce_url( 'admin.php?page=portfolios_pfhub_portfolio_portfolio&id=' . $id, 'apply_portfolio_' . $row->id, 'pfhub_portfolio_apply_portfolio_nonce' );
    ?>
            ...
            <div id="portfolio-header">
                <ul id="portfolios-list">
                    ...
                    foreach ( $rowsld as $rowsldires ) {
                        if ( $rowsldires->id != $row->id ) {
                            $edit_portfolio_safe_link = wp_nonce_url(
                                'admin.php?page=portfolios_pfhub_portfolio_portfolio&task=edit_cat&id=' . $rowsldires->id,
                            ...
                            <li>
                                <a href="#"
                                   ...
                                   onclick="window.location.href='<?php echo esc_url( 'admin.php?page=portfolios_pfhub_portfolio_portfolio&task=edit_cat&id=' . $rowsldires->id ) ?>'"><?php echo esc_html($rowsldires->name); ?></a>
                            </li>
                            <?php
                        } else { ?>
                            <li class="active">
                    ...
                    $add_new_portfolio_safe_link = wp_nonce_url(
                        'admin.php?page=portfolios_pfhub_portfolio_portfolio&task=add_portfolio',
                        'add_new_portfolio',
                                                ...
                                                <div class="category-container">
                                                    ...
                                                    <select class="pfhub_portfolio_input" id="multipleSelect" multiple="multiple" disabled>
                                                        ...
                                                        $remove_project_safe_link = wp_nonce_url(
                                                            'admin.php?page=portfolios_pfhub_portfolio_portfolio&id=' . $row->id . '&task=apply&removeslide=' . $rowimages->id,
                    ...
                    <div id="side-sortables" class="meta-box-sortables ui-sortable">
                        <div id="portfolio-unique-options" class="postbox">
                            ...
                            <ul id="portfolio-unique-options-list">
                                <li>
                                    <label
                                        for="pfhub_portfolio_portfolio_name"><?php echo __( 'Portfolio Name', 'pfhub_portfolio' ); ?></label>
                                    <input type="text" name="name" class="pfhub_portfolio_input" id="pfhub_portfolio_portfolio_name"
                                           value="<?php echo esc_html( stripslashes( $row->name ) ); ?>"
                                ...
                                <li>
                                    ...
                                    <select name="portfolio_effects_list" id="portfolio_effects_list">
                                        <option <?php if ( $row->grid_view_type == '0' ) {
                                            ...
                                            value="0"><?php echo __( 'Blocks Toggle Up/Down', 'pfhub_portfolio' ); ?></option>
                                        <option <?php if ( $row->grid_view_type == '1' ) {
                                            echo 'selected';
                                        } ?>
                                            value="1"><?php echo __( 'Masonry', 'pfhub_portfolio' ); ?></option>
                                        <option <?php if ( $row->grid_view_type == '2' ) {
                                            echo 'selected';
                                        } ?>
                                            value="2"><?php echo __( 'Gallery/Content-Popup', 'pfhub_portfolio' ); ?></option>
                                        <option <?php if ( $row->grid_view_type == '3' ) {
                                            echo 'selected';
                                        } ?>
                                            value="3"><?php echo __( 'List', 'pfhub_portfolio' ); ?></option>
                                        ...
                                        <option <?php if ( $row->grid_view_type == '6' ) {
                                            ...
                                            value="6"><?php echo __( 'Image Grid', 'pfhub_portfolio' ); ?></option>
                                ...
                                <ul>
                                    <li rel="tab-1" class="selected">
                                        ...
                                        <p><?php echo __( 'Copy &amp; paste the shortcode directly into any WordPress post or page', 'pfhub_portfolio' ); ?>
                                            .</p>
                                        <textarea class="full"
                                                  readonly="readonly">[pfhub_portfolio_portfolio id="<?php echo $row->id; ?>"]</textarea>
                                    </li>
                                    <li rel="tab-2">
                                        ...
                                        <p><?php echo __( 'Copy &amp; paste this code into a template file to include the slideshow within your theme', 'pfhub_portfolio' ); ?>
                                            .</p>
                                        <textarea class="full" readonly="readonly">&lt;?php echo do_shortcode("[pfhub_portfolio_portfolio id='<?php echo $row->id; ?>']"); ?&gt;</textarea>
                                    </li>
                                </ul>
                            </div>
                        </div>
