...
?>
<style>
section#pfhub_portfolio_portfolio_content_<?php echo $portfolioID; ?> {
    position:relative;
    display:block;
}
...
#pfhub_portfolio_portfolio_popup_list_<?php echo $portfolioID; ?> {
    position:fixed;
    display:table;
    width:80%;
    top:7%;
...
#pfhub_portfolio_portfolio_popup_list_<?php echo $portfolioID; ?>.active {display:table;}

#pfhub_portfolio_portfolio_popup_list_<?php echo $portfolioID; ?> li.pupup-element {
    position:relative;
    display:none;
    width:100%;
...
#pfhub_portfolio_portfolio_popup_list_<?php echo $portfolioID; ?> li.pupup-element.active {
    display:block;
}

#pfhub_portfolio_portfolio_popup_list_<?php echo $portfolioID; ?> .heading-navigation_<?php echo $portfolioID; ?> {
    position:absolute;
    width:100%;
    height:40px;
    top:0;
...
#pfhub_portfolio_portfolio_popup_list_<?php echo $portfolioID; ?> .heading-navigation_<?php echo $portfolioID; ?> .close,#pfhub_portfolio_portfolio_popup_list_<?php echo $portfolioID; ?> .heading-navigation_<?php echo $portfolioID; ?> .close:link, #pfhub_portfolio_portfolio_popup_list_<?php echo $portfolioID; ?> .heading-navigation_<?php echo $portfolioID; ?> .close:visited {
    position:relative;
    float:right;
    width:40px;
    height:40px;
...
#pfhub_portfolio_portfolio_popup_list_<?php echo $portfolioID; ?> .heading-navigation_<?php echo $portfolioID; ?> .close:hover, #pfhub_portfolio_portfolio_popup_list_<?php echo $portfolioID; ?> .heading-navigation_<?php echo $portfolioID; ?> .close:focus, #pfhub_portfolio_portfolio_popup_list_<?php echo $portfolioID; ?> .heading-navigation_<?php echo $portfolioID; ?> .close:active {opacity:1;}


#pfhub_portfolio_portfolio_popup_list_<?php echo $portfolioID; ?> li.pupup-element .pfhub-portfolio-popup-wrapper_<?php echo $portfolioID; ?> {
    position:relative;
    width:98%;
    height:98%;
    padding:2% 0% 0% 2%;
...
#pfhub_portfolio_portfolio_popup_list_<?php echo $portfolioID; ?> .pfhub-portfolio-popup-wrapper_<?php echo $portfolioID; ?> .image-block_<?php echo $portfolioID; ?> {
    width:55%;
...
#pfhub_portfolio_portfolio_popup_list_<?php echo $portfolioID; ?> .pfhub-portfolio-popup-wrapper_<?php echo $portfolioID; ?> .image-block_<?php echo $portfolioID; ?> img {
<?php
...
#pfhub_portfolio_portfolio_popup_list_<?php echo $portfolioID; ?> .pfhub-portfolio-popup-wrapper_<?php echo $portfolioID; ?> .right-block {
    width:42.8%;
    height: 100%;
    position:relative;
    float:left;
...
#pfhub_portfolio_portfolio_popup_list_<?php echo $portfolioID; ?> li.pupup-element .pfhub-portfolio-popup-wrapper_<?php echo $portfolioID; ?> .right-block > div {
    padding-top:10px;
    padding-right: 4%;
    margin-bottom:10px;
...
#pfhub_portfolio_portfolio_popup_list_<?php echo $portfolioID; ?> li.pupup-element .pfhub-portfolio-popup-wrapper_<?php echo $portfolioID; ?> .right-block > div:last-child {background:none;}


#pfhub_portfolio_portfolio_popup_list_<?php echo $portfolioID; ?> .pfhub-portfolio-popup-wrapper_<?php echo $portfolioID; ?> .right-block .title {
    position:relative;
    display:block;
...
#pfhub_portfolio_portfolio_popup_list_<?php echo $portfolioID; ?> .pfhub-portfolio-popup-wrapper_<?php echo $portfolioID; ?> .right-block .description {
    clear:both;
    position:relative;
    text-align:justify;
...
#pfhub_portfolio_portfolio_popup_list_<?php echo $portfolioID; ?> .pfhub-portfolio-popup-wrapper_<?php echo $portfolioID; ?> .right-block .description h1,
#pfhub_portfolio_portfolio_popup_list_<?php echo $portfolioID; ?> .pfhub-portfolio-popup-wrapper_<?php echo $portfolioID; ?> .right-block .description h2,
#pfhub_portfolio_portfolio_popup_list_<?php echo $portfolioID; ?> .pfhub-portfolio-popup-wrapper_<?php echo $portfolioID; ?> .right-block .description h3,
#pfhub_portfolio_portfolio_popup_list_<?php echo $portfolioID; ?> .pfhub-portfolio-popup-wrapper_<?php echo $portfolioID; ?> .right-block .description h4,
#pfhub_portfolio_portfolio_popup_list_<?php echo $portfolioID; ?> .pfhub-portfolio-popup-wrapper_<?php echo $portfolioID; ?> .right-block .description h5,
#pfhub_portfolio_portfolio_popup_list_<?php echo $portfolioID; ?> .pfhub-portfolio-popup-wrapper_<?php echo $portfolioID; ?> .right-block .description h6,
#pfhub_portfolio_portfolio_popup_list_<?php echo $portfolioID; ?> .pfhub-portfolio-popup-wrapper_<?php echo $portfolioID; ?> .right-block .description p,
#pfhub_portfolio_portfolio_popup_list_<?php echo $portfolioID; ?> .pfhub-portfolio-popup-wrapper_<?php echo $portfolioID; ?> .right-block .description strong,
#pfhub_portfolio_portfolio_popup_list_<?php echo $portfolioID; ?> .pfhub-portfolio-popup-wrapper_<?php echo $portfolioID; ?> .right-block .description span {
    padding:2px !important;
    margin:0 !important;
}

#pfhub_portfolio_portfolio_popup_list_<?php echo $portfolioID; ?> .pfhub-portfolio-popup-wrapper_<?php echo $portfolioID; ?> .right-block .description ul,
#pfhub_portfolio_portfolio_popup_list_<?php echo $portfolioID; ?> .pfhub-portfolio-popup-wrapper_<?php echo $portfolioID; ?> .right-block .description li {
    padding:2px 0 2px 5px;
    margin:0 0 0 8px;
}

#pfhub_portfolio_portfolio_popup_list_<?php echo $portfolioID; ?> .pfhub-portfolio-popup-wrapper_<?php echo $portfolioID; ?> .right-block ul.thumbs-list_<?php echo $portfolioID; ?> {
    list-style:none;
    display:table;
    position:relative;
    clear:both;
...
#pfhub_portfolio_portfolio_popup_list_<?php echo $portfolioID; ?> .pfhub-portfolio-popup-wrapper_<?php echo $portfolioID; ?> .right-block ul.thumbs-list_<?php echo $portfolioID; ?> li {
    display:block;
    float:left;
...
#pfhub_portfolio_portfolio_popup_list_<?php echo $portfolioID; ?> .pfhub-portfolio-popup-wrapper_<?php echo $portfolioID; ?> .right-block ul.thumbs-list_<?php echo $portfolioID; ?> li.active,#pfhub_portfolio_portfolio_popup_list_<?php echo $portfolioID; ?> .pfhub-portfolio-popup-wrapper_<?php echo $portfolioID; ?> .right-block ul.thumbs-list_<?php echo $portfolioID; ?> li:hover {
    opacity:1;
}

#pfhub_portfolio_portfolio_popup_list_<?php echo $portfolioID; ?> .pfhub-portfolio-popup-wrapper_<?php echo $portfolioID; ?> .right-block ul.thumbs-list_<?php echo $portfolioID; ?> li a {
    border:none;
    display:block;
}

#pfhub_portfolio_portfolio_popup_list_<?php echo $portfolioID; ?> .pfhub-portfolio-popup-wrapper_<?php echo $portfolioID; ?> .right-block ul.thumbs-list_<?php echo $portfolioID; ?> li img {
    margin:0 !important;
    padding:0 !important;
...
#pfhub_portfolio_portfolio_popup_list_<?php echo $portfolioID; ?> .pfhub-portfolio-popup-wrapper_<?php echo $portfolioID; ?> .image-block_<?php echo $portfolioID; ?> iframe  {
    width:100% !important;
    height:60% !important;
    display:block;
}

#pfhub_portfolio_portfolio_popup_list_<?php echo $portfolioID; ?> .heading-navigation_<?php echo $portfolioID; ?> .left-change, #pfhub_portfolio_portfolio_popup_list_<?php echo $portfolioID; ?> .heading-navigation_<?php echo $portfolioID; ?> .right-change{
    width: 40px;
    height: 39px;
    font-size: 25px;
...
#pfhub_portfolio_portfolio_popup_list_<?php echo $portfolioID; ?> .heading-navigation_<?php echo $portfolioID; ?> .right-change{
    position: relative;
    margin-left: -6px;
}

#pfhub_portfolio_portfolio_popup_list_<?php echo $portfolioID; ?> .heading-navigation_<?php echo $portfolioID; ?> .right-change:hover, #pfhub_portfolio_portfolio_popup_list_<?php echo $portfolioID; ?> .heading-navigation_<?php echo $portfolioID; ?> .left-change:hover{
    background: #ddd;
    border-color: #ccc;
    color: #000 !important;
    cursor: pointer;
...
#pfhub_portfolio_portfolio_popup_list_<?php echo $portfolioID; ?> .heading-navigation_<?php echo $portfolioID; ?> .right-change a, #pfhub_portfolio_portfolio_popup_list_<?php echo $portfolioID; ?> .heading-navigation_<?php echo $portfolioID; ?> .left-change a{
    position: absolute;
...
#pfhub_portfolio_portfolio_content_<?php echo $portfolioID; ?> #pfhub_portfolio_portfolio_options_<?php echo $portfolioID; ?> {
    position: relative;
    overflow: hidden;
...
#pfhub_portfolio_portfolio_content_<?php echo $portfolioID; ?> #pfhub_portfolio_portfolio_options_<?php echo $portfolioID; ?> ul {
    margin: 0 !important;
    padding: 0 !important;
    list-style: none;
<?php if($sortingFloatPopup == 'top') {
...
#pfhub_portfolio_portfolio_content_<?php echo $portfolioID; ?> #pfhub_portfolio_portfolio_filters_<?php echo $portfolioID; ?> ul {
    margin: 0 !important;
    padding: 0 !important;
    overflow: hidden;
...
#pfhub_portfolio_portfolio_content_<?php echo $portfolioID; ?> #pfhub_portfolio_portfolio_options_<?php echo $portfolioID; ?> ul li {
...
#pfhub_portfolio_portfolio_content_<?php echo $portfolioID; ?> #pfhub_portfolio_portfolio_options_<?php echo $portfolioID; ?> ul li a {
...
/*#pfhub_portfolio_portfolio_content_<?php echo $portfolioID; ?> #pfhub_portfolio_portfolio_options_<?php echo $portfolioID; ?> ul li:hover {

}*/

#pfhub_portfolio_portfolio_content_<?php echo $portfolioID; ?> #pfhub_portfolio_portfolio_options_<?php echo $portfolioID; ?> ul li a:hover {
...
#pfhub_portfolio_portfolio_content_<?php echo $portfolioID; ?> #pfhub_portfolio_portfolio_filters_<?php echo $portfolioID; ?> {
    position: relative;
    overflow: hidden;
<?php   if($filteringFloatPopup != 'top'){
...
#pfhub_portfolio_portfolio_content_<?php echo $portfolioID; ?> #pfhub_portfolio_portfolio_filters_<?php echo $portfolioID; ?> ul li {
    list-style-type: none;
...
#pfhub_portfolio_portfolio_content_<?php echo $portfolioID; ?> #pfhub_portfolio_portfolio_filters_<?php echo $portfolioID; ?> ul li a {
...
#pfhub_portfolio_portfolio_content_<?php echo $portfolioID; ?> #pfhub_portfolio_portfolio_filters_<?php echo $portfolioID; ?>  ul li a:hover {
...
#pfhub_portfolio_portfolio_content_<?php echo $portfolioID; ?> #pfhub_portfolio_portfolio_filters_<?php echo $portfolioID; ?> ul li.active a,
#pfhub_portfolio_portfolio_content_<?php echo $portfolioID; ?> #pfhub_portfolio_portfolio_filters_<?php echo $portfolioID; ?> ul li.active a:link,
#pfhub_portfolio_portfolio_content_<?php echo $portfolioID; ?> #pfhub_portfolio_portfolio_filters_<?php echo $portfolioID; ?> ul li.active a:visited,
#pfhub_portfolio_portfolio_content_<?php echo $portfolioID; ?> #pfhub_portfolio_portfolio_filters_<?php echo $portfolioID; ?>  ul li.active a:hover,
#pfhub_portfolio_portfolio_content_<?php echo $portfolioID; ?> #pfhub_portfolio_portfolio_filters_<?php echo $portfolioID; ?>  ul li.active a:focus,
#pfhub_portfolio_portfolio_content_<?php echo $portfolioID; ?> #pfhub_portfolio_portfolio_filters_<?php echo $portfolioID; ?>  ul li.active a:active {
    color:#<?php echo $pfhub_portfolio_get_options["pfhub_portfolio_view2_filterbutton_hover_font_color"];?> !important;
    background-color: #<?php echo $pfhub_portfolio_get_options["pfhub_portfolio_view2_filterbutton_hover_background_color"];?> !important;
    cursor: pointer;
}
#pfhub_portfolio_portfolio_content_<?php echo $portfolioID; ?> #pfhub_portfolio_portfolio_container_<?php echo $portfolioID; ?> {
    width: 79%;
...
@media screen and (max-width: 768px) {
    ...
    #pfhub_portfolio_portfolio_content_<?php echo $portfolioID; ?> #pfhub_portfolio_portfolio_filters_<?php echo $portfolioID; ?> ul li a,
    #pfhub_portfolio_portfolio_content_<?php echo $portfolioID; ?> #pfhub_portfolio_portfolio_filters_<?php echo $portfolioID; ?> ul li a:link,
    #pfhub_portfolio_portfolio_content_<?php echo $portfolioID; ?> #pfhub_portfolio_portfolio_filters_<?php echo $portfolioID; ?> ul li a:visited {
...
@media screen and (max-width: 480px) {
    ...
    #pfhub_portfolio_portfolio_content_<?php echo $portfolioID; ?> #pfhub_portfolio_portfolio_options_<?php echo $portfolioID; ?> #sort-by{
        float: left;
        width: 100% !important;
    }
    #pfhub_portfolio_portfolio_content_<?php echo $portfolioID; ?> #pfhub_portfolio_portfolio_options_<?php echo $portfolioID; ?> #port-sort-direction{
        float: left;
        width: 100% !important;
        position: relative;
...
@media screen and (max-width: <?php echo $pfhub_portfolio_get_options['pfhub_portfolio_view0_block_width']+2*$pfhub_portfolio_get_options['pfhub_portfolio_view2_element_border_width']+40; ?>px) {
    ...
    .pfhub-portfolio-panel_<?php echo $portfolioID; ?> {
        width: 100% !important;
    }
}
...
#pfhub_portfolio_portfolio_options_and_filters_<?php echo $portfolioID; ?>{
    position: relative;
    float: left;
    width: 20%;
    max-width: 180px;
