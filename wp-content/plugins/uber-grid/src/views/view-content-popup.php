...
<?php } ?>
    <div id="pfhub_portfolio_portfolio_container_<?php echo esc_attr($portfolioID); ?>"
         class="pfhub_portfolio_portfolio_container super-list variable-sizes clearfix view-<?php echo esc_attr($view_slug); ?>" <?php if ($sortingFloatPopup == "top" && $filteringFloatPopup == "top") {
        ...
        foreach ($images as $key => $row) {
            ...
            ?>
            <div id="pfhub_portfolio_portfolio_pupup_element_<?php echo esc_attr($row->id); ?>_child"
                ...
                <div class="image-block image-block_<?php echo esc_attr($portfolioID); ?>">
                    ...
                    <?php if ($row->image_url != ';') {
                        ...
                        <img alt="<?php echo esc_attr($row->name); ?>" id="pfhub-cl-img<?php echo esc_attr($key); ?>"
...
<ul id="pfhub_portfolio_portfolio_popup_list_<?php echo esc_attr($portfolioID); ?>" class="pfhub_portfolio_portfolio_popup_list">
    <?php
    $changePopup = 1;
    foreach ($images as $key => $row) {
        ...
        <li class="pupup-element <?php foreach ($catForFilter as $catForFilterValue) {
            echo str_replace(" ", "_", $catForFilterValue) . " ";
        } ?>" id="pfhub_portfolio_portfolio_pupup_element_<?php echo esc_attr($row->id); ?>">
            ...
            <div class="pfhub-portfolio-popup-wrapper pfhub-portfolio-popup-wrapper_<?php echo esc_attr($portfolioID); ?>">
                <div class="image-block_<?php echo esc_attr($portfolioID); ?> image-block">
                    ...
                    if ($row->image_url != ';') {
                        ...
                        <img alt="<?php echo esc_atr($row->name); ?>" id="pfhub-cl-img<?php echo esc_attr($key); ?>"
                             src="images/noimage.jpg"/>
                        <?php
                    } ?>
                </div>
