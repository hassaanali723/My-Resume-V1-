...
?>
<style>
#pfhub_portfolio_portfolio_container_<?php echo $portfolioID; ?> ul#portfolio-filter {
<?php if( $portfolioposition == 'on' ): ?> text-align: center;
<?php endif; ?>
}

#pfhub_portfolio_portfolio_container_<?php echo $portfolioID; ?> ul#portfolio-filter li {
<?php if( $portfolioposition == 'on' ): ?> float: none;
<?php endif; ?>
}

#pfhub_portfolio_portfolio_container_<?php echo $portfolioID; ?> ul#portfolio-filter a {
...
#pfhub_portfolio_portfolio_container_<?php echo $portfolioID; ?> ul#portfolio-filter li.current a {
...
#pfhub_portfolio_portfolio_container_<?php echo $portfolioID; ?> ul#portfolio-filter li.current a:hover {
    color: #<?php echo $pfhub_portfolio_get_options['pfhub_portfolio_view7_filter_button_font_active_color']; ?> !important;
    background-color: #<?php echo $pfhub_portfolio_get_options['pfhub_portfolio_view7_filter_button_bg_color_active']; ?> !important;
}

#pfhub_portfolio_portfolio_container_<?php echo $portfolioID; ?> ul#portfolio-filter a:hover {
...
#pfhub_portfolio_portfolio_container_<?php echo $portfolioID; ?> #pfhub_portfolio-container-loading-overlay_<?php echo $portfolioID; ?> {
    width: 100%;
    height: 100%;
    position: absolute;
    z-index: 1;
...
#pfhub_portfolio_portfolio_container_<?php echo $portfolioID; ?> #pfhub_portfolio_portfolio_content_<?php echo $portfolioID; ?> {
...
#pfhub_portfolio_portfolio_content_<?php echo $portfolioID; ?> .wagwep-container {
<?php if ( $portfolioShowFiltering != 'on' ): ?> display: none;
<?php endif; ?>
}

#pfhub_portfolio_portfolio_content_<?php echo $portfolioID; ?> ul.og-grid {
    padding: 0;
<?php if( $portfolioposition == 'on' ): ?> text-align: center;
<?php endif; ?>
}

#pfhub_portfolio_portfolio_content_<?php echo $portfolioID; ?> .og-grid > li {
...
#pfhub_portfolio_portfolio_content_<?php echo $portfolioID; ?> .og-grid > li > a {
    width: 100%;
    height: 100%;
    overflow: hidden;
    box-shadow: none;
...
#pfhub_portfolio_portfolio_content_<?php echo $portfolioID; ?> .og-grid li > a > img {
...
#pfhub_portfolio_portfolio_content_<?php echo $portfolioID; ?> .og-grid > li > a > figure > span {
...
#pfhub_portfolio_portfolio_content_<?php echo $portfolioID; ?> .og-grid > li .og-pointer {
    border-bottom-color: #<?php echo $pfhub_portfolio_get_options['pfhub_portfolio_view7_expand_block_background_color']; ?>;
}

#pfhub_portfolio_portfolio_content_<?php echo $portfolioID; ?> .og-grid > li > a > figure {
    background: <?php
...
#pfhub_portfolio_portfolio_content_<?php echo $portfolioID; ?> .og-expander {
...
#pfhub_portfolio_portfolio_content_<?php echo $portfolioID; ?> .og-expander .elastislide-wrapper {
...
#pfhub_portfolio_portfolio_content_<?php echo $portfolioID; ?> .og-expander ul.elastislide-list {
    max-height: none !important;
    padding: 0;
}

#pfhub_portfolio_portfolio_content_<?php echo $portfolioID; ?> .og-expander ul.elastislide-list li {
    margin: 0 2% 5px 1%;
...
#pfhub_portfolio_portfolio_content_<?php echo $portfolioID; ?> .og-expander ul.elastislide-list li > a > img {
    max-width: 100%;
    max-height: 100%;
    border: 2px solid #<?php echo $pfhub_portfolio_get_options['pfhub_portfolio_view7_thumbnail_bg_color']; ?>px;
}

#pfhub_portfolio_portfolio_content_<?php echo $portfolioID; ?> .og-expander ul.elastislide-list li > a > img.selected {
    border: 2px solid #999999;
}

#pfhub_portfolio_portfolio_content_<?php echo $portfolioID; ?> .og-expander ul.elastislide-list li > a {
    width: 100%;
    height: 100%;
}

#pfhub_portfolio_portfolio_content_<?php echo $portfolioID; ?> .og-expander .og-details a.link-button {
...
#pfhub_portfolio_portfolio_content_<?php echo $portfolioID; ?> .og-expander .og-details a.link-button:hover {
...
#pfhub_portfolio_portfolio_content_<?php echo $portfolioID; ?> .og-expander .og-expander-inner {
    display: inline-block;
    width: 100%;
}

#pfhub_portfolio_portfolio_content_<?php echo $portfolioID; ?> .og-expander .og-details p {
...
#pfhub_portfolio_portfolio_content_<?php echo $portfolioID; ?> .og-expander .og-close {
    z-index: 999;
}

#pfhub_portfolio_portfolio_content_<?php echo $portfolioID; ?> .og-expander .og-details {
    float: right;
    height: auto;
}

#pfhub_portfolio_portfolio_content_<?php echo $portfolioID; ?> .og-expander .og-details h3 {
    color: #<?php echo $pfhub_portfolio_get_options['pfhub_portfolio_view7_element_title_font_color']; ?>;
}

#pfhub_portfolio_portfolio_content_<?php echo $portfolioID; ?> .og-fullimg {
    height: 100%;
    float: left;
}

#pfhub_portfolio_portfolio_content_<?php echo $portfolioID; ?> .og-fullimg img {
    margin-bottom: 25px;
    width: 100%;
}

#pfhub_portfolio_portfolio_content_<?php echo $portfolioID; ?> .og-fullimg iframe {
    width: 100%;
    border: none;
    height: 82%!important;
}
