                ...
                <form action="admin.php?page=Options_portfolio_styles&task=save&pfhub_portfolio_nonce_save_gen_options" method="post" id="adminForm" name="adminForm">
                    <div id="portfolio-options-list">
                        ...
                        <ul id="portfolio-view-tabs">
                            ...
                            <li>
                                <a href="#portfolio-view-options-1"><?php echo __( 'Masonry', 'pfhub_portfolio' ); ?></a>
                            </li>
                            <li>
                                <a href="#portfolio-view-options-2"><?php echo __( 'Gallery/Content-Popup', 'pfhub_portfolio' ); ?></a>
                            </li>
                            <li>
                                <a href="#portfolio-view-options-3"><?php echo __( 'List', 'pfhub_portfolio' ); ?></a>
                            </li>
                            ...
                            <li>
                                <a href="#portfolio-view-options-6"><?php echo __( 'Image Grid', 'pfhub_portfolio' ); ?></a>
                            </li>
                            <li>
