...
<?php } ?>
    <div id="pfhub_portfolio_portfolio_container_<?php echo esc_attr($portfolioID); ?>"
         class="pfhub_portfolio_portfolio_container super-list variable-sizes clearfix view-<?php echo esc_attr($view_slug); ?>"
        ...
        foreach ( $images as $key => $row ) {
            ...
            <div
                ...
                <div class="default-block_<?php echo esc_attr($portfolioID); ?>">
                    <div class="image-block_<?php echo esc_attr($portfolioID); ?> add-H-relative">
                        ...
                        if ( $row->image_url != ';' ) {
                                    ...
                                    <a href="<?php echo esc_url( $imgurl[0] ); ?>"
                                       ...
                                       title="<?php echo esc_attr( $row->name ); ?>" data-groupID="<?php echo esc_attr($group_key);?>">
                                        <img alt="<?php echo esc_attr( $row->name ); ?>"
                                             id="pfhub-cl-img<?php echo esc_attr($key); ?>" data-title=" <?php echo \PfhubPortfolio\Helpers\GridHelper::getImageTitle($imgurl[0]); ?>"
                            ...
                            <img alt="<?php echo esc_attr( $row->name ); ?>" id="pfhub-cl-img<?php echo $key; ?>"
                ...
                <div class="pfhub-portfolio-panel_<?php echo esc_attr($portfolioID); ?>" id="panel<?php echo esc_attr($key); ?>">
                    <?php $imgurl = explode( ";", $row->image_url );
                    array_shift( $imgurl );
                                    ...
                                    <li>
                                        ...
                                        switch ( \PfhubPortfolio\Helpers\GridHelper::getVideoType( $img ) ) {
                                            ...
                                            case 'vimeo':
                                                ...
                                                $hash = unserialize( wp_remote_fopen( "https://vimeo.com/api/v2/video/" . $videourl[0] . ".php" ) );
                                                $imgsrc = $hash[0]['thumbnail_large']; ?>
                                                <a class="pfhub_portfolio_portfolio_item pvimeo portfolio-group<?php echo $group_key; ?> "
                                                   href="http://player.vimeo.com/video/<?php echo esc_attr($videourl[0]); ?>"
                                                   data-description=" <?php echo esc_attr( $row->description ); ?>"
