...
?>
<section id="pfhub_portfolio_portfolio_content_<?php echo esc_attr($portfolioID); ?>"
         style="clear: both"
...
<?php } ?>
	<div id="pfhub_portfolio_portfolio_container_<?php echo esc_attr($portfolioID); ?>"
	     ...
	     class="pfhub_portfolio_portfolio_container super-list variable-sizes clearfix view-<?php echo $view_slug; ?>" <?php if ( $pfhub_portfolio_get_options["pfhub_portfolio_view3_sorting_float"] == "top" && $pfhub_portfolio_get_options["pfhub_portfolio_view3_filtering_float"] == "top" ) {
						...
						if ( $row->image_url != ';' ) {
							switch ( \PfhubPortfolio\Helpers\GridHelper::getVideoType( $imgurl[0] ) ) {
								case 'image':
									...
									<a href="<?php echo esc_url( $imgurl[0] ); ?>"
									   ...
									   title="<?php echo esc_attr( $row->name ); ?>" data-groupID="<?php echo esc_attr($group_key);?>"><img
											...
											id="pfhub-cl-img<?php echo esc_attr($key); ?>"
								...
								case 'youtube':
									...
									<a href="https://www.youtube.com/embed/<?php echo esc_attr($videourl[0]); ?>"
                                       data-description=" <?php echo esc_attr( $row->description ); ?>"
									   class="pfhub_portfolio_portfolio_item pyoutube portfolio-group<?php echo esc_attr($group_key); ?> add-H-block"
								...
								case 'vimeo':
									...
									<a class="pfhub_portfolio_portfolio_item pvimeo portfolio-group<?php echo esc_attr($group_key); ?> add-H-block"
							...
							<a href="<?php echo esc_url( $imgurl[0] ); ?>"
							   class=" portfolio-group<?php echo esc_attr($group_key); ?>" data-groupID="<?php echo esc_attr($group_key);?>"><img
									alt="<?php echo esc_attr( $row->name ); ?>"
									id="pfhub-cl-img<?php echo esc_attr($key); ?>" src="images/noimage.jpg"></a>
							<?php
						}
						?>
					</div>
								...
								foreach ( $imgurl as $key => $img ) {
									switch ( \PfhubPortfolio\Helpers\GridHelper::getVideoType( $img ) ) {
										...
										case 'youtube':
											...
											<li>
												<a href="https://www.youtube.com/embed/<?php echo esc_attr($videourl[0]); ?>"
												   class="pfhub_portfolio_portfolio_item pyoutube portfolio-group<?php echo $group_key; ?>  add-H-relative"
                                                   data-description=" <?php echo esc_attr( $row->description ); ?>"
												   title="<?php echo esc_attr( $row->name ); ?>" data-groupID="<?php echo esc_attr($group_key);?>">
										...
										case 'vimeo':
											...
											$imgsrc = $hash[0]['thumbnail_large']; ?>
											<li>
												<a class="pfhub_portfolio_portfolio_item pvimeo portfolio-group<?php echo esc_attr($group_key); ?>  add-H-relative"
												   href="http://player.vimeo.com/video/<?php echo esc_attr($videourl[0]); ?>"
                                                   data-description=" <?php echo esc_attr( $row->description ); ?>"
												   title="<?php echo esc_attr( $row->name ); ?>" data-groupID="<?php echo esc_attr($group_key);?>">
													<img src="<?php echo esc_attr( $imgsrc ); ?>"
