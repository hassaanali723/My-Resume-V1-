...
<style>
    ...
    .pfhub-portfolio-panel_<?php echo $portfolioID; ?> .button-block a,
    .pfhub-portfolio-panel_<?php echo $portfolioID; ?> .button-block a:link,
    .pfhub-portfolio-panel_<?php echo $portfolioID; ?> .button-block a:visited {
        padding:10px;
        display:inline-block;
    ...
    #pfhub_portfolio_portfolio_content_<?php echo $portfolioID; ?> section {
        position:relative;
        display:block;
    }
