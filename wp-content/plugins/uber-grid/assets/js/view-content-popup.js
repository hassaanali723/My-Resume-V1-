...
function PortfolioHub_Content_Popup(id) {
    ...
    _this.overlayClick = function(){
        ...
        jQuery('#pfhub_portfolio_portfolio_pupup_element_' + strid).addClass('active').css({height: height * 0.7});
        _this.popupList.addClass('active');

        jQuery('#pfhub_portfolio_portfolio_pupup_element_' + strid + ' ul.thumbs-list li:first-child').addClass('active');
    ...
    _this.leftChange = function(){
        ...
        if (jQuery(this).closest(".pupup-element").prevAll(".pupup-element" + active_rel).length) {
            ...
            jQuery('#pfhub_portfolio_portfolio_pupup_element_' + strid).css({height: height * 0.7});
...
jQuery(document).ready(function () {
    jQuery(".pfhub_portfolio_portfolio_container.view-content-popup").each(function (i) {
