...
function PortfolioHub_Image_Grid(id) {
    var _this = this;
    _this.container = jQuery('#' + id + '.view-image-grid');
    ...
    _this.defaultBlockWidth = portfolio_param_obj.pfhub_portfolio_view6_width;
    ...
    _this.documentReady = function () {
        var options = {
            ...
            masonry: {
                columnWidth: _this.defaultBlockWidth + 10 + portfolio_param_obj.pfhub_portfolio_view6_border_width * 2,
            },
            masonryHorizontal: {
                rowHeight: 300 + 10
            },
    ...
    _this.showCenter = function () {
        if (_this.isCentered) {
            ...
            var elementwidth = _this.defaultBlockWidth + 10 + portfolio_param_obj.pfhub_portfolio_view6_border_width * 2;
...
jQuery(document).ready(function () {
    jQuery(".pfhub_portfolio_portfolio_container.view-image-grid").each(function (i) {
        var id = jQuery(this).attr('id');
        portfolios[i] = new PortfolioHub_Image_Grid(id);
    });
});
