...
function PortfolioHub_Grid(id) {
    ...
    _this.dropdownableClick = function () {
        var strheight = 0;
        jQuery(this).parents('.portelement').find('.pfhub-portfolio-panel > div').each(function () {
...
jQuery(document).ready(function () {
    jQuery(".pfhub_portfolio_portfolio_container.view-grid").each(function (i) {
        var id = jQuery(this).attr('id');
        portfolios[i] = new PortfolioHub_Grid(id);
    });
});
