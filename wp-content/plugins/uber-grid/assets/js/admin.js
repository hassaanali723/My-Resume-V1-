...
var portfoliosListNameChange = function (e) {
    document.getElementById("pfhub_portfolio_portfolio_name").value = e.value;
};
jQuery(document).ready(function () {
	...
	jQuery('.pfhub_portfolio-insert-edited-video-button').click(function (e) {
		...
		var videoEditSafeLink = 'admin.php?page=portfolios_pfhub_portfolio_portfolio&task=portfolio_video_edit&grid_id='+portfolioId+'&id='+portfolioItemId+'&thumb='+videoIndexInArray+'&portfolio_video_edit_nonce='+videoEditNonce+'&TB_iframe=1&closepop=1';
	...
	jQuery('.pfhub_portfolio-insert-video-button').click(function (e) {
		...
		jQuery(this).parent().attr('action', 'admin.php?page=portfolios_pfhub_portfolio_portfolio&task=portfolio_video&id=' + portfolioId + '&portfolio_add_video_nonce=' + portfolioVideoAddNonce + '&closepop=1').submit();
	});
